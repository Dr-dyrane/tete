    ...
    <div className="flex flex-col text-white justify-center items-center min-h-screen px-2">
      ...
      <div className="space-x-2 flex text-xs md:text-xs lg:text-sm">
        ...
        <div>
          ...
          <div className="space-y-2">
            <p className="infoText">"Change the TêteB0T Model to use"</p>
            <p className="infoText">
              "Messages are stored in Firebase's Firestore"
            </p>
            <p className="infoText">
              "Hot Toast notifications when Bot is thinking!
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            <p className="infoText">
              "May occasionally generate purulent information"
            </p>
            <p className="infoText">
              "May occasionally produce harmfull instructions or biased content"
            </p>
            <p className="infoText">
